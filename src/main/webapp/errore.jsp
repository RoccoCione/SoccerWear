...
.navlink{color:#fff;text-decoration:none;font-weight:800;font-size:clamp(25px,1.8vw,30px);}
.navlink:hover{color:#000000}
.back{width:25px;height:25px}
</style>
</head>
<body>
...
<div class="content">
	<h3>Ciao ospite !!!</h3>
	<p>Stai provando ad accedere ad una sezione che non ti riguarda. Hai provato con l' <a href="<%=ctx%>/logout" class="navlink"><i class="fa-solid fa-user-secret"></i>Accesso</a> ?</p>
</div>
</body>
</html>
